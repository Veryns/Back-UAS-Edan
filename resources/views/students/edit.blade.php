...
<p>
    <a href="{{ route('students.show', $student->student_id) }}" style="display:inline-block;padding:6px 12px;border:1px solid #999;background:#f1f1f1;color:#000;text-decoration:none;border-radius:4px;">← Kembali</a>
</p>
